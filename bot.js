 ...
 if (message.content === "+خصاءص") {
  ...
  const embed = new Discord.RichEmbed() 
      ...
      .setDescription(`
             ...
             Oméega Bot , 
آلبوت الأول الذي يوفر لك مميزات حصرية , 
وبعض الإوامر قد تكون مدفوعه ببوتات أخرى  , 
من مميزاتنا :
- دعم فني 24 ساعه دون توقف
- حمايه كامله لسيرفرك , مع تثبيته بالكامل
- يعمل على خوادم مستقله مما يضمن اداء اسرع
- خاصية الفويس أون لاين .. بأمكان اظهار عدد المتصلين بالرومات الصوتية
- خاصية سحب الإعضاء من الروم الصوتي والطرد الصوتي 
- لوحة تحكم بسيطة [ Soon ]
والكثير من المميزات التى لا تستطيع ذاكراتي ذكرها وقد تكون مدفوعه ببوتات اخري
لعرض جميع المميزات يرجى الدخول إلي سيرفر الدعم,
https://discord.gg/rNU5Bm9
أو عبر توصل مع صاحب البوت :
- Up | Skillz ,💤 - 🎶 .#6562
@everyone
...
if (message.content.startsWith('+aball')){ 
